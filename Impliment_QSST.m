function [monomials1,reactionrates1,monomials2,reactionrates2,monomials3,...
    reactionrates3,monomials4,reactionrates4,s1,s2,s3,s4] = Impliment_QSST(polyfunc1,polyfunc2,V)
...
[monomials1,reactionrates1] = Gillespie_format(polyfunc1,s(1),s(2),s3,s4,ghost,ghost1,1);
[monomials2,reactionrates2] = Gillespie_format(polyfunc2,s(1),s(2),s3,s4,ghost,ghost1,1);
...
% Form the degenerate system induced by QSST
polyfunc1 = polyfunc1 - sum(monomials1.*replaceposition1.*reactionrates1) + sum(newmonomials1.*reactionrates1) + kg * ghost + kg1 * ghost1;
polyfunc2 = polyfunc2 - sum(monomials2.*replaceposition2.*reactionrates2) + sum(newmonomials2.*reactionrates2) + kg * ghost + kg1 * ghost1;
polyfunc1 = expand(polyfunc1);
polyfunc2 = expand(polyfunc2);
