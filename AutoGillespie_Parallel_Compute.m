function [xx_1,xx_2,xx_3,xx_4] = AutoGillespie_Parallel_Compute(polyfunc1,polyfunc2,Gilltime,initial_condition,NumRealize,V)
...
[monomials1,reactionrates1,monomials2,reactionrates2,monomials3,...
    ...
    = Impliment_QSST(polyfunc1,polyfunc2,V);
